...
function woo_breadcrumbs( $args = array() ) {
    ...
    if(is_archive() && $term->name == "product"){
        $link = false;
        
        if($link){
            $trail[] = '<a href="/product-information/">Product Information</a>';
        }
        else {
            $trail[] = 'Product Information';
        }
    }
