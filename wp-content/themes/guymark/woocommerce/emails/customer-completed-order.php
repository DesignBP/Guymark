...
<tr><td align="left">
	...
	<table width="614" cellspacing="0" cellpadding="6" border="0" style="font-family: sans-serif, Arial;font-size: 13px;text-align: left;color: #303030;line-height: 19px;">
        <tr>
            <td height="45" style="text-align: left;"><h1 style="line-height: 0px;text-align: left;color: #2e89c9;font-size: 23px;">Your order is complete</h1></td>
        </tr>
        <tr>
            <td height="21" style="text-align: left;"><p style="margin: 0px;padding: 1px;line-height: 19px;text-align: left;color: #303030;">Dear Customer, <br /><br />Your recent order on Guymark has been completed.<br>Your order details are shown below for your reference:</p></td>
        </tr>
