 ...
 * @version     2.0.3
 	...
 	<!-- table item -->
	<tr>
		<td style="text-align: left;border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;">KR Disposable Eartips (#KR001)<br><small>Tip-Size: 3-6mm</small></td>
		<td align="left" style="text-align: left;border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;">4</td>
		<td align="left" style="text-align: left;border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;">&pound;48</td>
	</tr>
...
foreach ( $items as $item ) :
	...
	if ( ! is_object( $_product ) ) :
		?>
		<tr>
			<td style="text-align:left; vertical-align:middle; word-wrap:break-word;border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;">
			<?php
			...
			<td style="text-align:left; vertical-align:middle; border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;"><?php echo $item['qty'] ;?></td>
			<td style="text-align:left; vertical-align:middle; border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;"><?php echo $order->get_formatted_line_subtotal( $item ); ?></td>
		</tr>
		<?php
	else :
		...
		?>
		<tr>
			<td style="text-align:left; vertical-align:middle; word-wrap:break-word;border-bottom: 1px solid #d3d3d3;border-left: 1px solid #d3d3d3;"><?php
		...
		<?php if ($show_purchase_note && $purchase_note = get_post_meta( $_product->id, '_purchase_note', true)) : ?>
			<tr>
				<td colspan="3" style="text-align:left; vertical-align:middle; border: 1px solid #d3d3d3;"><?php echo apply_filters('the_content', $purchase_note); ?></td>
			</tr>
		<?php endif; ?>
	<?php endif; ?>
<?php endforeach; ?>
