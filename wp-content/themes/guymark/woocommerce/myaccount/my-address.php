...
<p class="myaccount_address">
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used during checkout:', 'woocommerce' ) ); ?>
</p>
		...
		<address>
			<?php
				...
				if ( ! $formatted_address )
					_e( 'No address currently set', 'woocommerce' );
				else
					echo $formatted_address;
			?>
		</address>
		<a href="<?php echo esc_url( add_query_arg('address', $name, get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ); ?>" class="edit"><?php _e( 'Edit address', 'woocommerce' ); ?></a>
	</div>
